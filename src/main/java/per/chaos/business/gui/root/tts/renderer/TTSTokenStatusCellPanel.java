...
package per.chaos.business.gui.root.tts.renderer;
...
public class TTSTokenStatusCellPanel extends JPanel implements ListCellRenderer<TokenStatusDTO> {
    ...
    private void initComponents() {
        ...
        labelNextRefreshTextSuffix = new JLabel();
        ...
        //======== panelOther ========
        {
            ...
            //---- labelNextRefreshTip ----
            labelNextRefreshTip.setText("\u4e0b\u6b21\u5237\u65b0\u65f6\u95f4\uff1a");
            ...
            //---- labelNextRefreshTextSuffix ----
            labelNextRefreshTextSuffix.setText("\u540e");
            panelOther.add(labelNextRefreshTextSuffix);
        }
        add(panelOther);
    ...
    private JLabel labelNextRefreshTextSuffix;
