...
import per.chaos.app.ioc.Stereotype;
...
public final class Reflections {
    ...
    /**
     * Gets stereotypes of the specified class.
     *
     * @param clazz the specified class
     * @return stereotypes of the specified class
     */
    ...
    public static String[] getMethodVariableNames(final Class<?> clazz, final String targetMethodName, final Class<?>[] types) {
        ...
        try {
            ...
            log.error("Get method variable names failed", e);
        }
    ...
    public static Set<Field> getInheritedFields(final Class<?> clazz) {
        ...
        final Set<Field> declaredFieldSet = CollectionsUtils.arrayToSet(fields);
    ...
    public static Set<Method> getOwnMethods(final Class<?> clazz) {
        ...
        final Set<Method> declaredMethodSet = CollectionsUtils.arrayToSet(methods);
